...
def load_data(path):
    ...
    # Step to define transforms for the training, validation, and testing sets
    ...
    return train_data, trainloader, validloader, testloader,class_to_idx
...
# _, _, _, _,class_to_idx = load_data(path)
